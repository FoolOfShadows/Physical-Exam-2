...
struct ENT {
	...
	private func processENTSubSectionsFrom(_ tag:[Int]) -> String {
		...
		for item in tag {
			...
			case 4: resultArray.append("mild hearing loss")
			case 5: resultArray.append("moderate hearing loss")
			case 6: resultArray.append("severe hearing loss")
			case 7: resultArray.append("uses hearing aid in right ear")
			case 8: resultArray.append("uses hearing aid in left ear")
			case 9: resultArray.append("uses hearing aids in both ears")
			case 41: resultArray.append("dentition normal")
			case 20: resultArray.append("normal nasal mucosa, normal septum and turbinates, no obstruction")
			case 23: resultArray.append("front sinus tenderness")
			case 24: resultArray.append("maxillary sinus tenderness")
			case 10, 13, 16,28, 33, 52: resultArray.append("red")
